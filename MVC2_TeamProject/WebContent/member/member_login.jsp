...
$(function(){
	...
	if(id == ''){
		$("input[name='id']").val($("input[name='id']").attr("placeholder"));
	}
	});
});
</script>
...
<body style="margin: auto; text-align: center;">
	...
	<table>
		<tr>
			<th colspan="3"><button onclick="location.href='createui.do'">회원가입</button>
				<button>비번찾기</button> <button onclick="formSubmit()">로그인</button></th>
